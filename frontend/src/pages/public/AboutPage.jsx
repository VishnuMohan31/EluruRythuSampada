  ...
  return (
    <div className="about-page">
      <div className="container">
        ...
        >
          <h1 className="page-title">Celebrating Tribal Artisans of Andhra Pradesh</h1>
          ...
          <section className="about-section">
            <div className="section-text">
              ...
              <p>
                ...
                rich heritage and exceptional craftsmanship of tribal communities across Andhra Pradesh.
              </p>
              <p>
            ...
            <div className="section-image">
              <img src={about2Img} alt="Tribal artisan crafting" />
            </div>
          </section>
          ...
          <section className="how-it-works">
            ...
            <div className="steps-grid">
              <div className="step-card">
                ...
                <h3>Explore</h3>
                <p>Browse authentic tribal handicrafts, textiles, jewelry, and home decor from Andhra Pradesh artisans.</p>
              </div>
              <div className="step-card">
                <div className="step-number">2</div>
                <h3>Learn</h3>
                <p>Discover the stories behind each craft, the tribal communities, and traditional techniques used.</p>
              </div>
              <div className="step-card">
          ...
          <section className="platform-purpose">
            ...
            <div className="purpose-content">
              <p>
                ...
                of Andhra Pradesh's tribal artisans. We provide a space where artisans can showcase their products
              ...
              <div className="trust-indicators">
                ...
                <div className="trust-item">
                  <span className="trust-icon">🎯</span>
                  <span>Authentic Tribal Products Only</span>
                </div>
              </div>
            </div>
          </section>
